    ...
    <>
      ...
      <div className="flex h-screen w-full items-center justify-center text-center flex-col z-40">
        ...
        <div
          ...
          className="hover:animate-bounce my-5 px-10 rounded-full bg-red-500 shadow-md shadow-black hover:bg-red-600 text-7xl font-extrabold text-white p-4 text-center hover:cursor-pointer"
        >
          {"🎲 "}
          LAUNCH
        </div>
